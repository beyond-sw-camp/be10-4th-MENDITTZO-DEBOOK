...
public interface ReviewQueryRepository extends JpaRepository<Review, Long> {
    ...
    @Query("SELECT new com.mendittzo.review.query.application.dto.ReviewResponseDTO(r.reviewId, r.title, r.content, r.rating, u.nickname, r.createDatetime, r.updateDatetime, r.userId, r.bookId) " +
